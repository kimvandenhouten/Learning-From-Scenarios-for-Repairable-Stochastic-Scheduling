...
"""
These distribution classes are used in the Simulator. This simulator is created for a biomanufacturing scheduling application based 
...
class NormalDistribution(Distribution):
    ...
    def sample(self):
        sample = np.random.normal(self.mean, self.variance, 1)[0]
        return sample
