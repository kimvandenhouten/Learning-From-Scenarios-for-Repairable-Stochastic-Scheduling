...
from problems.RCPSP_penalty.solver.stochastic_solver import solve_rcpsp_penalty_stochastic
...
""" 
This Python script runs the stochastic algorithm for the industry instances.
"""
...
for id in [1, 2, 3, 4, 5]:
    for penalty_type in ["small", "large"]:
        for instance_size in [5, 10, 20]:
            ...
            results.to_csv(f'results/industry_small/{penalty_type}/stoch_{instance_size}_{id}_s={seed}_tr={train_size}_'
