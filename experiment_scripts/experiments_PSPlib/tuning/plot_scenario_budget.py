...
for i, folder_path in enumerate([f"results/tuning/j30_tuning/scenario_budget/{penalty_type}"]):
...
unique_algorithms = ["decision-focused", "deterministic", "stochastic"]
...
for instance_name, instance_group in grouped_instances:
    ...
    plt.savefig(f'plots/j30_tuning/scenario_budget_{penalty_type}_{instance_name}.png')
    ...
    legend_fig.savefig(f'plots/j30_tuning/legend_scenario_budget_{penalty_type}.png')